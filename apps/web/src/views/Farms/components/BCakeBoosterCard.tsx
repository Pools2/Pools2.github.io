...
export const BCakeProxyCakeBalanceCard = () => {
  ...
  return !isLoading && bCakeProxyBalance > 0 ? (
    <Message marginBottom="8px" variant="warning">
      <MessageText>
        {t(
          'There is %amount% RPAY in the proxy booster contract. In order to harvest that amount you should withdraw, deposit or harvest one of the boosted farms.',
...
export const BCakeBoosterCard = () => {
  ...
  return (
    <CardWrapper>
      <ImageWrapper>
        <Image
          src="https://plaxswap.github.io/apps/web/public/images/boosterCardImage.png"
