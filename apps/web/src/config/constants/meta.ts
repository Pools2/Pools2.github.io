...
export const DEFAULT_META: PageMeta = {
  title: 'Roxyswap',
  description:
    'The most popular AMM on Polygon by user count! Earn RPAY through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Roxyswap), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/pancake-squad': { basePath: true, title: t('Roxyswap Squad') },
